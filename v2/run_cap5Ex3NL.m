...
finalCond = {1,[]}; % For IVP finalCond={}. For BVP finalCond = {u1(L), u2(L),...,un(L)}, put [] on emty spaces  
alpha = 1; % Troesch’s parameter 

%% Define the equation, its derivatives and an initial guess
f = @(t,x) [x(2),alpha*sinh(alpha*x(1))]; % Troesch’s equation 
d_uf = @(t,x)[0, 1; alpha*cosh(alpha*x(1)), 0];
